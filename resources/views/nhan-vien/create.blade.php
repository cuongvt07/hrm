                                    ...
                                    <div class="p-4 border-end">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="ma_nhanvien" name="ma_nhanvien"
                                                value="{{ old('ma_nhanvien', $nextCode) }}" required readonly>
                                        </div>
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="tab-content" id="employeeTabContent">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="card border-0 bg-light mb-4">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="mb-3">
                                                                    <label for="ho" class="form-label">Họ <span
                                                                            class="text-danger">*</span></label>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="tinh_trang_hon_nhan" class="form-label">Tình
                                                                        trạng hôn nhân</label>
                                                                    <select class="form-select" id="tinh_trang_hon_nhan"
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="card border-0 bg-light mb-4">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="mb-3">
                                                                    <label for="quoc_tich" class="form-label">Quốc
                                                                        tịch</label>
                                                                    <input type="text" class="form-control" id="quoc_tich"
                                                                        name="quoc_tich" value="Việt Nam">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="dan_toc" class="form-label">Dân tộc</label>
                                                                    <input type="text" class="form-control" id="dan_toc"
                                                                        name="dan_toc" value="Kinh">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="ton_giao" class="form-label">Tôn
                                                                        giáo</label>
                                                                    <input type="text" class="form-control" id="ton_giao"
                                                                        name="ton_giao">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="dia_chi" class="form-label">Địa chỉ</label>
                                                                    <textarea class="form-control" id="dia_chi"
                                                                        name="dia_chi" rows="2"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="card border-0 bg-light mb-4">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="mb-3">
                                                                    <label for="phong_ban_id" class="form-label">Phòng
                                                                        ban<span class="text-danger">*</span></label>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="chuc_vu_id" class="form-label">Chức vụ<span
                                                                            class="text-danger">*</span></label>
                                                                    <select class="form-select" id="chuc_vu_id"
                                                                        name="chuc_vu_id">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="date" class="form-control"
                                                                        id="ngay_vao_lam" name="ngay_vao_lam">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="ngay_thu_viec" class="form-label">Ngày thử
                                                                        việc</label>
                                                                    <input type="date" class="form-control"
                                                                        id="ngay_thu_viec" name="ngay_thu_viec">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="card border-0 bg-light mb-4">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="quan_ly_truc_tiep_id"
                                                                        class="form-label">Quản lý trực tiếp</label>
                                                                    <select class="form-select" id="quan_ly_truc_tiep_id"
                                                                        name="quan_ly_truc_tiep_id">
                                                        ...
                                                        <div class="card border-0 bg-light mb-4">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="mb-3">
                                                                            <label for="luong_co_ban"
                                                                                class="form-label">Lương cơ bản</label>
                                                                            <input type="text" class="form-control bg-light"
                                                                                id="luong_co_ban" name="luong_co_ban"
                                                                                value="{{ old('luong_co_ban') ? number_format(old('luong_co_ban'), 0, ',', '.') : '' }}"
                                                                                readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="mb-3">
                                                                            <label for="so_tai_khoan" class="form-label">Số
                                                                                tài khoản ngân hàng</label>
                                                                            <input type="text" class="form-control"
                                                                                id="so_tai_khoan" name="so_tai_khoan"
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="mb-3">
                                                                            <label for="ten_ngan_hang"
                                                                                class="form-label">Tên ngân hàng</label>
                                                                            <input type="text" class="form-control"
                                                                                id="ten_ngan_hang" name="ten_ngan_hang"
                                                                                value="{{ old('ten_ngan_hang') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="mb-3">
                                                                            <label for="chi_nhanh_ngan_hang"
                                                                                class="form-label">Chi nhánh ngân
                                                                                hàng</label>
                                                                            <input type="text" class="form-control"
                                                                                id="chi_nhanh_ngan_hang"
                                                                                name="chi_nhanh_ngan_hang"
                                                                                value="{{ old('chi_nhanh_ngan_hang') }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="card border-0 bg-light mb-4">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="mb-3">
                                                                    <label for="dien_thoai_di_dong" class="form-label">Điện
                                                                        thoại di động</label>
                                                                    <input type="text" class="form-control"
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="dien_thoai_khac" class="form-label">Điện
                                                                        thoại khác</label>
                                                                    <input type="text" class="form-control"
                                                                        id="dien_thoai_khac" name="dien_thoai_khac">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="card border-0 bg-light mb-4">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="mb-3">
                                                                    <label for="email_co_quan" class="form-label">Email cơ
                                                                        quan</label>
                                                                    <input type="email" class="form-control"
                                                                        id="email_co_quan" name="email_co_quan">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="email_ca_nhan" class="form-label">Email cá
                                                                        nhân</label>
                                                                    <input type="email" class="form-control"
                                                                        id="email_ca_nhan" name="email_ca_nhan">
                                                                </div>
                                                                <div class="card-header bg-secondary text-white mt-3">
                                                                    <h5 class="mb-0">Địa chỉ</h5>
                                                                </div>
                                                                <div class="mb-3 mt-2">
                                                                    <label for="dia_chi_thuong_tru" class="form-label">Địa
                                                                        chỉ thường trú</label>
                                                                    <textarea class="form-control" id="dia_chi_thuong_tru"
                                                                        name="dia_chi_thuong_tru" rows="2"></textarea>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="dia_chi_hien_tai" class="form-label">Địa chỉ
                                                                        hiện tại</label>
                                                                    <textarea class="form-control" id="dia_chi_hien_tai"
                                                                        name="dia_chi_hien_tai" rows="2"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card border-0 bg-light mb-4">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label for="lien_he_khan_cap_ten"
                                                                                class="form-label">Tên</label>
                                                                            <input type="text" class="form-control"
                                                                                id="lien_he_khan_cap_ten"
                                                                                name="lien_he_khan_cap_ten">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label for="lien_he_khan_cap_quan_he"
                                                                                class="form-label">Quan hệ</label>
                                                                            <input type="text" class="form-control"
                                                                                id="lien_he_khan_cap_quan_he"
                                                                                name="lien_he_khan_cap_quan_he">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label for="lien_he_khan_cap_dien_thoai"
                                                                                class="form-label">Điện thoại</label>
                                                                            <input type="text" class="form-control"
                                                                                id="lien_he_khan_cap_dien_thoai"
                                                                                name="lien_he_khan_cap_dien_thoai">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="family" role="tabpanel">
                                                ...
                                                <p class="text-muted">Sau khi tạo nhân viên thành công, bạn có thể thêm
                                                    thông tin thành viên gia đình từ trang chỉnh sửa.</p>
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="documents" role="tabpanel">
                                                ...
                                                <p class="text-muted">Sau khi tạo nhân viên thành công, bạn có thể upload
                                                    tài liệu từ trang chỉnh sửa.</p>
                                            </div>

                                            <!-- Giấy tờ & chứng chỉ tờ tùy thân Tab -->
                                            <div class="tab-pane fade" id="giayto" role="tabpanel">
                                                <div class="alert alert-info">
                                                    <!-- ...existing code... -->
                                                    Giấy tờ & chứng chỉ tờ tùy thân có thể được thêm sau khi tạo nhân viên.
                                                </div>
                                                <p class="text-muted">Sau khi tạo nhân viên thành công, bạn có thể thêm giấy
                                                    tờ tùy thân từ trang chỉnh sửa.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="ngay_tham_gia_bh" class="form-label">Ngày tham gia BH</label>
                                    <input type="date" class="form-control" id="ngay_tham_gia_bh" name="ngay_tham_gia_bh"
                                        value="{{ old('ngay_tham_gia_bh') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="ty_le_dong_bh" class="form-label">Tỷ lệ đóng BH (%)</label>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="so_so_bhxh" class="form-label">Số sổ BHXH</label>
                                    <input type="text" class="form-control" id="so_so_bhxh" name="so_so_bhxh"
                                        value="{{ old('so_so_bhxh') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="ma_so_bhxh" class="form-label">Mã số BHXH</label>
                                    <input type="text" class="form-control" id="ma_so_bhxh" name="ma_so_bhxh"
                                        value="{{ old('ma_so_bhxh') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="tham_gia_bao_hiem" class="form-label">Tham gia bảo hiểm</label>
                                    <select class="form-select" id="tham_gia_bao_hiem" name="tham_gia_bao_hiem">
                                        <option value="1" {{ old('tham_gia_bao_hiem') == '1' ? 'selected' : '' }}>Có</option>
                                        <option value="0" {{ old('tham_gia_bao_hiem') == '0' ? 'selected' : '' }}>Không
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tinh_cap" name="tinh_cap"
                                        value="{{ old('tinh_cap') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="ma_tinh_cap" class="form-label">Mã Tỉnh cấp</label>
                                    <input type="text" class="form-control" id="ma_tinh_cap" name="ma_tinh_cap"
                                        value="{{ old('ma_tinh_cap') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="so_the_bhyt" class="form-label">Số thẻ BHYT</label>
                                    <input type="text" class="form-control" id="so_the_bhyt" name="so_the_bhyt"
                                        value="{{ old('so_the_bhyt') }}">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            form.addEventListener('submit', function (e) {
                ...
                fetch(form.action, {
                    ...
                    .then(async response => {
                        ...
                        submitBtn.innerHTML = 'Lưu nhân viên';
                        if (response.ok) {
