                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $taiKhoan->nhanVien->phongBan->ten ?? '-' }}" disabled>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Chức vụ</label>
                            <input type="text" class="form-control" value="{{ $taiKhoan->nhanVien->chucVu->ten ?? '-' }}" disabled>
                        </div>
